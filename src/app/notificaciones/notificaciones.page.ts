...
export class NotificacionesPage implements OnInit {
  ...
  badge: boolean = false;
  loader:any;
  constructor(private router: Router,private db: DatabaseService , private alertCtrl: AlertController, private storage: Storage,private loadingCtrl:LoadingController) { }
  ...
  get() {
    ...
    this.storage.get('start_date').then((val) => {
      this.db.getRealTimeDBQuery('upds/notificaciones', ref=>
